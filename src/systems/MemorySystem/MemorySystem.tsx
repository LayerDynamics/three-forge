...
export class MemorySystem {
  ...
  /**
   * Unregisters a memory object by its ID and triggers cleanup if necessary.
  ...
  public calculateStats(objects: MemoryObject[]): MemoryStats {
    ...
    // Calculate largestObjects (top 5 largest)
    const largestObjects = Object.values(objects)
  ...
  private performCleanup(): void {
    ...
    for (const object of objects) {
      ...
      useMemoryStore.getState().removeObject(object.id);
