...
export class PostProcessingSystem {
  ...
  public addEffect(effect: PostProcessingEffect): void {
    let effectInstance;
    const resolution = new Vector2(this.config.width, this.config.height);
    ...
    switch (effect.type) {
      case 'bloom':
        ...
        break;
      case 'dof':
        effectInstance = new DOFEffect(effect.uniforms as any, resolution);
        break;
      case 'ssao':
        effectInstance = new SSAOEffect(effect.uniforms as any, resolution);
        break;
      case 'motionBlur':
        effectInstance = new MotionBlurEffect(effect.uniforms as any, resolution);
        break;
      default:
