...
build_encoder() {
    ...
    if [ "$ENCODER_NAME" == "basis_transcoder" ]; then
        ...
        OUTPUT_FILES=("libktx.js" "libktx_read.js" "msc_basis_transcoder.js" "libktx.wasm" "libktx_read.wasm" "msc_basis_transcoder.wasm")
    else
    ...
    # Additionally, if ENCODER_NAME is ktx2_encoder, copy from tests/webgl if not already copied
