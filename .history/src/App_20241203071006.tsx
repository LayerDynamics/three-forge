...
import { Html } from "@react-three/drei"; // Ensure Html is imported
...
import AudioInitializer from "./components/UI/AudioInitializer"; // Ensure AudioInitializer is imported
import "./App.css";
...
const ModelViewer: React.FC<{ assetId: string }> = ({ assetId }) => {
  ...
  if (!asset.loaded) {
    ...
    return (
      <Html center>
        <div style={{ color: "black", background: "rgba(255, 255, 255, 0.8)", padding: "10px", borderRadius: "5px" }}>
