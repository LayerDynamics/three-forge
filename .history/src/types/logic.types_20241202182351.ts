...
export interface LogicState {
	...
	registerLogicComponent: (component: LogicComponent) => void; // Function to register a new logic component
	unregisterLogicComponent: (id: string) => void; // Function to unregister a logic component
}
