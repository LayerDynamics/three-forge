...
export interface SerializedCamera {
	// Define the properties for SerializedCamera
}

export interface SerializedParticles {
	// Define the properties for SerializedParticles
}

export interface SerializedPlayerState {
	// Define the properties for SerializedPlayerState
}

export interface SerializedGameState {
	// Define the properties for SerializedGameState
}

export interface SerializedInventory {
	// Define the properties for SerializedInventory
}
