...
describe("WeaponSystem", () => {
  ...
  it("should equip a weapon", () => {
    ...
    const equippedWeaponId = weaponSystem.getWeapon("bow")?.id;
    expect(weaponSystem.equippedWeaponId).toBe("bow");
    expect(equippedWeaponId).toBe("bow");
  });
  ...
  it("should handle firing rate restrictions", () => {
    ...
    // Attempt to fire immediately after last fired
