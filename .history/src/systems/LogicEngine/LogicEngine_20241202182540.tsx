...
import { GameEvent, LogicComponent, GameState } from "../../types/logic.types";
...
export class LogicEngineClass {
  ...
  public reset(): void {
    ...
    const assets = useLogicStore.getState().logicComponents;
    Object.keys(assets).forEach((id) => this.unregisterLogicComponent(id));
