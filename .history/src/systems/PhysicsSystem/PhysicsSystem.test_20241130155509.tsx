...
describe("PhysicsSystemManager", () => {
  ...
  it("should handle collision callbacks for RapierPhysics", () => {
    ...
    // Simulate a collision by invoking handleCollision directly with correct event structure
    ...
    handleCollision(rapierEvent, body, "rapier");
  ...
  it("should handle collision callbacks for CannonPhysics", () => {
    ...
    handleCollision(cannonEvent, body, "cannon");
