...
const handleCollision = (event: CollisionEnterPayload) => {
  ...
  const contactPoint = event.collider.translation();
  // Convert contact point to Vector3
  const point = new Vector3(contactPoint.x, contactPoint.y, contactPoint.z);
  return { otherBodyId, point };
};
...
export class PhysicsSystemManager {
  ...
  private bodies: Record<string, PhysicsBody> = {};
