...
const RapierPhysicsDebug: React.FC = () => {
  return <RapierPhysicsDebugComponent />;
};

// Alias to avoid naming conflict
const RapierPhysicsDebugComponent: React.FC = () => {
  // The actual Rapier debug component can be imported and used here
  // Ensure you have imported Debug from @react-three/rapier
  return null; // Placeholder; replace with actual Debug component
};
