...
export class SceneGraphSystemClass {
   ...
   */
  public addObject(id: string, name: string, object3D: Object3D): void {
    const node: SceneGraphNode = { id, name, childrenIds: [], object3D };
  ...
  private processEvents(): void {
    const dequeueEvent = useLogicStore.getState().dequeueEvent;
    const handleEvent = (event: GameEvent) => this.handleEvent(event);
