...
// Mock the useSceneGraphStore module
jest.mock("../../stores/sceneGraphStore", () => {
  // Get the actual module to preserve types
  const actualModule = jest.requireActual("../../stores/sceneGraphStore");
  return {
    __esModule: true,
    ...actualModule,
...
// Mock the useLogicStore module
jest.mock("../../stores/logicStore", () => {
  const actualModule = jest.requireActual("../../stores/logicStore");
  return {
    __esModule: true,
    ...actualModule,
...
describe("SceneGraphSystem", () => {
  ...
  beforeEach(() => {
    ...
    (useSceneGraphStore as jest.MockedFunction<
    ...
    (useLogicStore as jest.MockedFunction<
      UseBoundStore<StoreApi<any>>
    >).mockReturnValue({
      getState: () => ({
        gameState: "menu",
