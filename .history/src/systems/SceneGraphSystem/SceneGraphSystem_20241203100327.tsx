...
import { Object3D, Scene, Mesh, BufferGeometry } from "three";
import {
  SceneGraphConfig,
  SceneGraphStoreNode,
  SceneGraphState,
...
import { MemorySystemInstance } from "../MemorySystem/MemorySystem";
...
// Initialize the SceneGraphSystem (typically done in a central initialization file)
