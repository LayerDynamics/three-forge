...
import {
  SceneGraphNode,
  SceneGraphStoreNode as OriginalSceneGraphStoreNode, // Rename to avoid conflict
  SceneGraphState,
} from "../../types/sceneGraph.types";
import { LogicComponent } from "../../types/logic.types";

// Extend the original SceneGraphStoreNode to include object3D
interface SceneGraphStoreNode extends OriginalSceneGraphStoreNode {
  object3D: Object3D;
}
