...
export class SceneGraphSystemClass {
  ...
  public addObject(id: string, name: string, object3D: Object3D, parentId?: string): void {
    ...
    const node: SceneGraphNode = { id, name, childrenIds: [], parentId };
    useSceneGraphStore.getState().addObject(node); // Changed from addNode to addObject
    if (parentId) {
  ...
  public removeObject(id: string): void {
    ...
    if (node) {
      useSceneGraphStore.getState().removeObject(id); // Changed from removeNode to removeObject
