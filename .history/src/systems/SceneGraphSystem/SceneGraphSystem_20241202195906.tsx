...
import { GameEvent, LogicComponent } from "../../types/logic.types"; // Corrected import
...
export class SceneGraphSystemClass {
  ...
  public static getInstance(config: SceneGraphConfig = {}, threeScene: Scene): SceneGraphSystemClass {
    if (!SceneGraphSystemClass.instance) {
      if (!threeScene) {
        throw new Error("threeScene is required to create SceneGraphSystemClass instance.");
      }
...
let threeSceneInstance: Scene; // You need to assign this appropriately in your application
export const SceneGraphSystem = SceneGraphSystemClass.getInstance({}, threeSceneInstance);