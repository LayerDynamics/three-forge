...
import { SceneGraphConfig, SceneGraphNode, GameEvent } from "../../types/sceneGraph.types";
...
export class SceneGraphSystemClass {
  ...
  /**
   * Initializes the SceneGraphSystem with configuration and Three.js Scene reference.
   * @param config Configuration options.
   * @param threeScene The Three.js Scene instance.
   */
  public initialize(config: SceneGraphConfig = {}, threeScene: Scene): void {
    this.config = config;
    this.threeScene = threeScene;
    if (this.config.debug) {
      console.log("SceneGraphSystem initialized with new config:", config);
    }
  }
...
export const SceneGraphSystem = SceneGraphSystemClass.getInstance();
