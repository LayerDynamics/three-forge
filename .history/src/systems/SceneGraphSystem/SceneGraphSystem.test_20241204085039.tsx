...
describe("SceneGraphSystem", () => {
  ...
  beforeEach(() => {
    ...
    addSpy = jest.spyOn(Object3D.prototype, "add").mockImplementation(function () {
      // Default mock implementation
    });
    removeSpy = jest.spyOn(Object3D.prototype, "remove").mockImplementation(function () {
      // Default mock implementation
    });
  ...
  it("should reset the SceneGraphSystem correctly", () => {
    ...
    expect(SceneGraphSystem.reset).toBeDefined();
  });
  ...
  it("should handle adding and moving objects within the SceneGraphSystem", () => {
    ...
    expect(mockAddNode).toHaveBeenCalledWith(parentStoreNode);
    expect(mockAddNode).toHaveBeenCalledWith(childStoreNode);
    ...
    expect(mockRemoveNode).toHaveBeenCalledWith(parentNode.id);
    expect(mockRemoveNode).toHaveBeenCalledWith(childNode.id);
    ...
    expect(mockRemove).not.toHaveBeenCalledWith(childNode.object3D);
