...
describe("SceneGraphSystem", () => {
  ...
  it("should handle adding multiple objects and resetting correctly", () => {
    ...
    // Assert: removeNode was called with each node.id in the correct order
  ...
  it("should handle adding and moving objects within the SceneGraphSystem", () => {
    ...
    expect(mockRemoveNode).toHaveBeenNthCalledWith(1, parentNode.id);
    expect(mockRemoveNode).toHaveBeenNthCalledWith(2, childNode.id);
