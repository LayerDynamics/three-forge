...
import { OcclusionConfig } from '../../types/occlusion.types';
...
describe('OcclusionSystem', () => {
  ...
  afterEach(() => {
    ...
    if (mockObject.material) {
      if (Array.isArray(mockObject.material)) {
        mockObject.material.forEach((material) => material.dispose());
      } else {
