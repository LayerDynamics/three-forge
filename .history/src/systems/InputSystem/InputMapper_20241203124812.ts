// src/systems/Input/InputMapper.ts
...
export class InputMapper {
	...
	public mapGamepadButtonToAction(button: number): InputAction|null {
		for(const [_,binding] of this.bindings) {
			if(binding.device==='gamepad'&&binding.buttons?.includes(button)) {
				return binding.action;
			}
		}
		return null;
