...
import { LODLevel, LODObject } from './lod.types';
import {
  Camera,
  Vector3,
  BufferGeometry,
...
import { useLODStore } from './LODSystem';
...
describe('LODSystem', () => {
  ...
  beforeEach(() => {
    ...
    // Assuming EventDispatcher is part of your utils, ensure it's reset appropriately
    // (EventDispatcher as any).events = {}; // Uncomment if necessary
