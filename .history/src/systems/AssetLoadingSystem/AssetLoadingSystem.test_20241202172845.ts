...
describe("AssetLoadingSystem", () => {
  ...
  it("should load a model asset successfully", (done) => {
    ...
    const mockGLTFLoaderInstance = (GLTFLoader as jest.Mock).mock.instances[0];
  ...
  it("should load a texture asset successfully", (done) => {
    ...
    const mockTextureLoaderInstance = (TextureLoader as jest.Mock).mock.instances[0];
  ...
  it("should load a sound asset successfully", (done) => {
    ...
    const mockAudioLoaderInstance = (AudioLoader as jest.Mock).mock.instances[0];
