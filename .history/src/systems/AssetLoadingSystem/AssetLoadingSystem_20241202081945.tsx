      ...
      case "video":
        this.loaders.video?.load(
          ...
          (video: HTMLVideoElement) => {
            ...
            if (this.config.debug) {
              console.log(`Video loaded: ${asset.id}`);
            }
            EventDispatcher.dispatch("ASSET_LOADED", {
              id: asset.id,
              type: asset.type,
          ...
          (xhr: ProgressEvent) => {
            ...
            if (this.config.debug) {
              console.log(
                `Loading video ${asset.id}: ${Math.round(percentComplete)}%`
              );
            }
          },
          (error: ErrorEvent) => {
            ...
            console.error(`Error loading video ${asset.id}:`, error);
            EventDispatcher.dispatch("ASSET_ERROR", {
              id: asset.id,
              type: asset.type,
              error: error.message,
