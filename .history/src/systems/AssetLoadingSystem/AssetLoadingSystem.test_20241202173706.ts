...
// Define a custom type for mocked loaders with 'load' as jest.Mock
type MockedLoader={
	load: jest.Mock;
};
...
describe("AssetLoadingSystem",() => {
	...
	it("should load a model asset successfully",(done) => {
		...
		const mockGLTFLoaderInstance=MockedGLTFLoader.mock.instances[0] as MockedLoader;
	...
	it("should load a texture asset successfully",(done) => {
		...
		const mockTextureLoaderInstance=MockedTextureLoader.mock.instances[0] as MockedLoader;
	...
	it("should load a sound asset successfully",(done) => {
		...
		const mockAudioLoaderInstance=MockedAudioLoader.mock.instances[0] as MockedLoader;
