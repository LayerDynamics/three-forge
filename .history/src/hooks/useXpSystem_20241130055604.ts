...
// Purpose: Custom hook for interacting with the XP System.
// 	Responsibilities:
// Expose functions to add XP,query current levels,and determine rewards.
// Trigger UI updates when the player gains XP or levels up.
// Depends On:
// XpSystem.
// Interacts With:
// playerStore to sync player-level changes.
// UI components like CooldownBar for showing XP progress.
// Example API:

// const {currentXp,level,addXp}=useXpSystem();

// addXp(50); // Add 50 XP to the current player
