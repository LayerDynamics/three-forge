...
const App: React.FC = () => {
  ...
  // 1. Move initialization to separate function and define it before useEffect
  ...
  // 2. Memoize the handler to prevent recreating on every render
  ...
  // 3. Add proper dependencies and guards
  useEffect(() => {
  ...
  return (
    <ErrorBoundary>
      <div className="App">
        <Canvas>
          {/* Ensure InitializationManager is inside Canvas to use R3F hooks */}
