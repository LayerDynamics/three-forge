...
import InitializationManager from "./components/InitializationManager"; // New component
import "./App.css";
...
const App: React.FC = () => {
  ...
  // Memoize the handleAddObject function
  ...
  // Initialization of class-based systems is now handled by InitializationManager
  // Remove any redundant initialization logic here if present
  ...
  useEffect(() => {
    ...
    addWeapon("sword");
    addWeapon("bow");
    addBox(new Object3D()); // Replace with actual Object3D instances
    addSphere(new Object3D());
  ...
  return (
    <ErrorBoundary>
      <div className="App">
        <Canvas>
          <InitializationManager /> {/* Centralized Initialization */}
