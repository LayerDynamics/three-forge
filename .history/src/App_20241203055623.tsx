...
import SceneGraphManager from "./components/SceneGraphManager/SceneGraphManager"; // Correct import
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // If you have AbilitySystem and WeaponSystem, ensure they're correctly imported and used
    // Example:
